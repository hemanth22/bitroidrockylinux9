...
Vagrant.configure("2") do |config|
  ...
  #config.vm.hostname = "bitroidrocky"
  #config.vm.network "private_network", ip: "193.16.44.10"
  ...
  #config.vbguest.iso_path = "#{ENV['HOME']}/Downloads/VBoxGuestAdditions_7.1.4.iso"
